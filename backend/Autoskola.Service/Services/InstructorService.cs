...
namespace Autoskola.Service.Services
{
    public class InstructorService : IInstructorService
    {
        ...
        public async Task<IEnumerable<InstructorGetVM>> GetAllIncludeCities(string? search, int pageNumber, int pageSize)
        {
            var users = await unitOfWork.Instructors.GetAllIncludeCities(search, pageNumber, pageSize);
            return mapper.Map<List<InstructorGetVM>>(users);
        }
